...
args = parser.parse_args()#args=['b','resnext101','cuda','train','0','384','--use_tuned_pos_weight','--batch-size', '10','--tta','1'])
...
#model.load_state_dict(torch.load('model_weight/ResNet152_FL384_flno_epoch7.pkl',map_location=device))
...
#                     clear_output(wait=True)
    ...
    pred_labels = np.mean(propotion_arr_TTA,axis=0) > thr
